...
test('front-end exposes manual outbound controls', async () => {
  ...
  assert.match(html, /id="detourOptions"/);
  assert.match(js, /data-field="detour"/);
  assert.match(js, /detourOptionValues/);
  assert.match(js, /setupDetourCombobox/);
  assert.match(js, /openDetourMenu/);
  assert.match(js, /closeDetourMenus/);
  assert.match(js, /aria-expanded/);
  assert.doesNotMatch(js, /list="detourOptions"/);
  assert.match(js, /applyManualDetour/);
